...
public:
    ...
    void setupUi(QDialog *Dialog_UserInfo_update)
    {
        ...
        Dialog_UserInfo_update->resize(517, 533);
        ...
        pushButton->setGeometry(QRect(50, 460, 141, 31));
        pushButton_2 = new QPushButton(Dialog_UserInfo_update);
        pushButton_2->setObjectName(QStringLiteral("pushButton_2"));
        pushButton_2->setGeometry(QRect(320, 460, 141, 31));
        ...
        label_8->setGeometry(QRect(-10, 20, 831, 20));
        ...
        label_9->setGeometry(QRect(20, 50, 72, 21));
