...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        tableWidget->setGeometry(QRect(130, 90, 521, 291));
        ...
        QIcon icon1;
        icon1.addFile(QStringLiteral(":/new/prefix1/up.jpg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon2;
        icon2.addFile(QStringLiteral(":/new/prefix1/stop.jpg"), QSize(), QIcon::Normal, QIcon::Off);
        stop_button->setIcon(icon2);
        ...
        QIcon icon3;
        icon3.addFile(QStringLiteral(":/new/prefix1/delete.jpg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon4;
        icon4.addFile(QStringLiteral("img/search.jpg"), QSize(), QIcon::Normal, QIcon::Off);
        search_button_2->setIcon(icon4);
        ...
        QIcon icon5;
        icon5.addFile(QStringLiteral("img/curreng_load.jpg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon6;
        icon6.addFile(QStringLiteral("img/file_load.jpg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon7;
        icon7.addFile(QStringLiteral("img/delete_but.jpg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        search_text->setGeometry(QRect(40, 110, 81, 20));
        ...
        QIcon icon8;
        icon8.addFile(QStringLiteral(":/new/prefix1/search.jpg"), QSize(), QIcon::Normal, QIcon::Off);
        search_button->setIcon(icon8);
        ...
        already_flie_but->setGeometry(QRect(40, 180, 81, 21));
        QFont font2;
        ...
        delete_file_but->setGeometry(QRect(40, 210, 81, 23));
        ...
        current_file_load_btn->setGeometry(QRect(40, 140, 81, 23));
        pushButton = new QPushButton(widget);
        pushButton->setObjectName(QStringLiteral("pushButton"));
        pushButton->setGeometry(QRect(10, 140, 21, 23));
        QIcon icon9;
        icon9.addFile(QStringLiteral(":/new/prefix1/curreng_load.jpg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon10;
        icon10.addFile(QStringLiteral(":/new/prefix1/file_load.jpg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon11;
        icon11.addFile(QStringLiteral(":/new/prefix1/delete_but.jpg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon12;
        icon12.addFile(QStringLiteral("img/new_load.jpg"), QSize(), QIcon::Normal, QIcon::Off);
        new_work_button_2->setIcon(icon12);
        ...
        QIcon icon13;
        icon13.addFile(QStringLiteral("img/load.jpg"), QSize(), QIcon::Normal, QIcon::Off);
        load_button_2->setIcon(icon13);
        ...
        QIcon icon14;
        icon14.addFile(QStringLiteral("img/up.jpg"), QSize(), QIcon::Normal, QIcon::Off);
        up_button_2->setIcon(icon14);
        ...
        QIcon icon15;
        icon15.addFile(QStringLiteral("img/stop.jpg"), QSize(), QIcon::Normal, QIcon::Off);
        stop_button_2->setIcon(icon15);
        ...
        QIcon icon16;
        icon16.addFile(QStringLiteral("img/delete.jpg"), QSize(), QIcon::Normal, QIcon::Off);
        delete_button_2->setIcon(icon16);
        delete_button_2->setIconSize(QSize(52, 52));
        pushButton_7 = new QPushButton(widget);
        pushButton_7->setObjectName(QStringLiteral("pushButton_7"));
        pushButton_7->setGeometry(QRect(10, 240, 16, 23));
        QIcon icon17;
        icon17.addFile(QStringLiteral(":/new/prefix1/user.jpg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        user_info->setGeometry(QRect(40, 240, 81, 23));
        pushButton_8 = new QPushButton(widget);
        pushButton_8->setObjectName(QStringLiteral("pushButton_8"));
        pushButton_8->setGeometry(QRect(10, 270, 21, 23));
        QIcon icon18;
        icon18.addFile(QStringLiteral("img/load_but.jpg"), QSize(), QIcon::Normal, QIcon::Off);
        pushButton_8->setIcon(icon18);
        ...
        set_load_speed->setGeometry(QRect(40, 270, 81, 23));
        user_login_btn = new QPushButton(widget);
        user_login_btn->setObjectName(QStringLiteral("user_login_btn"));
        user_login_btn->setGeometry(QRect(30, 20, 75, 61));
        QIcon icon19;
        icon19.addFile(QStringLiteral(":/new/prefix1/user_img.jpg"), QSize(), QIcon::Normal, QIcon::Off);
        user_login_btn->setIcon(icon19);
        user_login_btn->setIconSize(QSize(60, 60));
